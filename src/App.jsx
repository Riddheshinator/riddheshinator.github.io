...
const profile = {
  ...
  summary:
    'I am a Commerce and Information Systems student who is passionate about finance, accounting, and understanding how businesses and people make important financial decisions. I enjoy learning new things, solving problems, and working with others, which has led me to gain experience across financial services, mortgage broking support, CRM systems, and student mentoring. Through these experiences, I have developed strong communication, analytical, and interpersonal skills, and I am excited to continue growing both personally and professionally within the finance and business world.',
};
    ...
    <section id="about" className="px-5 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-32 lg:pt-36">
      <div className="mx-auto max-w-4xl">
        <div className="reveal">
          ...
          <p className="mt-5 max-w-3xl text-xl leading-8 text-cyan sm:text-2xl">
            {profile.title}
          </p>
